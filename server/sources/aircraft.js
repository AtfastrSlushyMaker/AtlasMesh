...
exports.startAircraftSource = startAircraftSource;
 ...
 */
function startAircraftSource(onEntities, opts) {
    ...
    async function fetchWithRetry(input, opts) {
        const retries = opts?.retries ?? 2;
        for (let attempt = 0; attempt <= retries; attempt++) {
            try {
                const authOptions = { timeout: 10000 };
                ...
                const res = await axios_1.default.get(input, authOptions);
